...
public class MyChain extends Chain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Range: " + java.util.Arrays.toString(c1.toArray()));

        MyChain c3 = c1.union(c2);
        System.out.println("Union: " + java.util.Arrays.toString(c3.toArray()));

        MyChain inter = c1.intersection(c2);
        System.out.println("Intersection: " + java.util.Arrays.toString(inter.toArray()));
